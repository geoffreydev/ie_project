    ...
    <div class="um_box_mid">
        <div class="um_box_mid_content">
            <div class="um_box_mid_content_top">
                <span class="umstyle1"><?php echo __('Customers'); ?></span>
                <span class="umstyle2" style="float:right"><?php echo $this->Html->link(__("Add New Customer",true),"/customers/add") ?></span>
                ...
                <table cellspacing="0" cellpadding="10" width="100%" border="0" >
                    ...
                    if (!empty($users)) {
                        ...
                        foreach ($users as $row) {
                            ...
                            $sl++;
                            if ($row['User']['user_group_id'] == 2)
                            {
                                ?>
                                <tr class="<?php echo $trtype;?>" ><?php

                                echo "<td><a href='".$this->Html->url('/customers/view/'.$row['User']['id'])."'>".h($row['User']['first_name'])." ".h($row['User']['last_name'])."</td>";
