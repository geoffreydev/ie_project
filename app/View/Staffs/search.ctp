     ...
     <div class="um_box_mid">
         <div class="um_box_mid_content">
             <div class="um_box_mid_content_top">
                 <span class="umstyle1"><?php echo __('Staff Search Results'); ?></span>
...
<thead>
  <tr><th>Name</th><th>Username</th><th>Phone</th><!--<th class="sorttable_nosort">Actions</th>--></tr>
            ...
            if ($user['User']['user_group_id'] == 1)
            {
             ...
             <?php echo "<td><a href='".$this->Html->url('/staffs/view/'.$user['User']['id'])."'>".h($user['User']['first_name'])." ".h($user['User']['last_name'])."</td>"; ?>
