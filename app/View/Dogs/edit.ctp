    ...
    <div class="um_box_mid">
        <div class="um_box_mid_content">
            <div class="um_box_mid_content_top">
                <span class="umstyle1"><?php echo __('Edit Dog Details'); ?></span>
                <span class="umstyle2" style="float:right"><?php
                    if ($this->Session->read('UserAuth.User.user_group_id') == 1){
                        echo $this->Html->link(__("Back to customer",true),"/customers/");
                    } else {
...
<?php
    ...
    <tr>
        ...
        <td>
            <?php echo $this->Form->input('comment',array('type'=>'textarea', 'style'=>'width:300px; height:150px;','label' => '', 'maxlength' => '250')); ?>
        </td>
        <td width="250px">
