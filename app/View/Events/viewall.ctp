...
function noWeekendsOrHolidays(date) {
    ...
    <div id="editform">
        ...
        echo $this->Form->create('Event',array('action'=>'display/0','enctype' => 'multipart/form-data'));//,'action' => 'viewall/0/'));
		?>
        ...
        <TD>
            ...
            <div class="um_box_mid_content_top">
                <span class="umstyle1"><?php
                    ...
                    if($id == 0)
                    {
                        echo __('All Bookings for "Today"');
                    }
                    elseif($id == 1)
                    {
        ...
        <div id="products">
		 ...
		 foreach($events as $event) {
			 ...
			 <tr class=<?php echo $trtype; ?>>
                 <td><?php echo $this->Html->link($event['User']['first_name'].' '.$event['User']['last_name'],array('controller'=>'customers','action'=>'view', $event['Event']['event_userid']));?></td>
                 <td><?php
