...
?>
<div id="dashboard">
	<div style="float:left"><?php echo $this->Html->link(__("Administration",true),"/dashboard") ?></div>
<?php   if ($this->UserAuth->isAdmin()) { ?>
	<!--<div style="float:left;padding-left:10px"><?php echo $this->Html->link(__("Add User",true),"/addUser") ?></div> -->
	<div style="float:left;padding-left:10px"><?php echo $this->Html->link(__("Customers",true),"/allUsers") ?></div>
    <div style="float:left;padding-left:10px"><?php echo $this->Html->link(__("Staff",true),"/allUsers") ?></div>
	...
	<!--<div style="float:left;padding-left:10px"><?php echo $this->Html->link(__("Edit Profile",true),"/editUser/".$this->UserAuth->getUserId()) ?></div>-->
        <div style="float:left;padding-left:10px"><?php echo $this->Html->link(__("Groomings",true),"/allGroomings") ?></div>
<?php   } else {?>
