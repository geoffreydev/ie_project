	...
	<div class="um_box_mid">
		<div class="um_box_mid_content">
			<div class="um_box_mid_content_top">
				...
				<span class="umstyle2" style="float:right"><?php echo $this->Html->link(__("New Customer",true),"/addUser") ?></span>
...
<!--							<th><?php echo __('Created');?></th> -->
			...
			<?php       if (!empty($users)) {
							...
							foreach ($users as $row) {
								...
								echo "<tr>";
//								echo "<td>".$sl."</td>";
								echo "<td><a href='".$this->Html->url('/viewUser/'.$row['User']['id'])."'>".h($row['User']['first_name'])." ".h($row['User']['last_name'])."</td>";
