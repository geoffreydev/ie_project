	...
	<div class="um_box_mid">
		<div class="um_box_mid_content">
			<div class="um_box_mid_content_top">
				<span class="umstyle1"><?php echo __('Log In or'); ?></span>
				<span  class="umstyle2"><?php echo $this->Html->link(__("Register",true),"/register") ?></span>
			...
			<div class="um_box_mid_content_mid" id="login">
				<div class="um_box_mid_content_mid_left">
					...
					<div>
						...
						<div class="umstyle4"><?php echo $this->Form->Submit(__('Log In'));?></div>
						<div style="clear:both"></div>
					</div>
