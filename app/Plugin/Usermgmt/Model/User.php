...
class User extends UserMgmtAppModel {
    ...
    public function confirmPhone() {
            $value=false;
        if ($this->data['User']['mobile_phone']!=''){
            $value=true;
        }
        if ($this->data['User']['landline_phone']!=''){
            $value=true;
        }
        if ($this->data['User']['work_phone']!=''){
            $value=true;
        }
        return $value;
    }
    ...
    public function validatePhone() {
        $value=true;
        if ($this->data['User']['mobile_phone']!='' && strlen($this->data['User']['mobile_phone'])!=10){
            $value=false;
        }
        if ($this->data['User']['landline_phone']!='' && strlen($this->data['User']['landline_phone'])!=10){
            $value=false;
        }
        if ($this->data['User']['work_phone']!='' && strlen($this->data['User']['work_phone'])!=10){
            $value=false;
        }
        return $value;
    }
	...
	public function forgotPassword($user) {
		...
		$body= "Welcome ".$user['User']['first_name'].", let's help you get logged in
